...
@Test(groups = {"randomCyberdevice"})
public class RandomCyberdeviceTest {

    @Test
    public void ensureOneCyberdeviceIsSelected() throws InvalidRandomElementSelectedException {
        ...
        characterPlayer.getCalling().getSelectedPerksOptions().get(0).getSelections().add(new Selection(PerkFactory.getInstance().getElement("destinator")));
