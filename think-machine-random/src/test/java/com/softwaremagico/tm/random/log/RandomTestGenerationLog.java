package com.softwaremagico.tm.random.log;
...
public final class RandomTestGenerationLog extends BasicLogger {

    private static final Logger LOGGER = LoggerFactory.getLogger(RandomTestGenerationLog.class);

    private RandomTestGenerationLog() {
