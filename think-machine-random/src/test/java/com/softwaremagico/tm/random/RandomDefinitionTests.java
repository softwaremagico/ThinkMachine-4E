...
public class RandomDefinitionTests {
    ...
    public void enduranceIsRecommendedToVorox() {
        Assert.assertFalse(CharacteristicsDefinitionFactory.getInstance().getElement("endurance").getRandomDefinition().getRecommendedSpecies().size() == 0);
    ...
    public void enduranceIsRecommendedToMilitary() {
        Assert.assertFalse(WeaponFactory.getInstance().getElement("trenchKnife").getRandomDefinition().getRecommendedPerksGroups().size() == 0);
