...
public final class RandomSelectorLog extends BasicLogger {

    private static final Logger LOGGER = LoggerFactory.getLogger(RandomSelectorLog.class);

    private RandomSelectorLog() {
