...
public class RandomProfileFactory extends XmlFactory<RandomProfile> {
    private static final String XML_FILE = "profiles.xml";

    private static final class RandomProfileFactoryInit {
        private static final RandomProfileFactory INSTANCE = new RandomProfileFactory();
    }
