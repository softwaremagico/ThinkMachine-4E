...
public abstract class FadingSunsTheme {
    ...
    public static final int SECTION_SUBTITLE_HIGH = 10;
    public static final int LINE_PADDING = 15;
    public static final int CHARACTER_BASICS_FONT_SIZE = 12;
    public static final int CHARACTERISTICS_TITLE_FONT_SIZE = 14;
    public static final int LINE_FONT_SIZE = 10;
    ...
    public static final int SHIELD_CONTENT_FONT_SIZE = ARMOUR_CONTENT_FONT_SIZE;
    public static final int ITEMS_CONTENT_FONT_SIZE = 6;
    public static final int WEAPONS_CONTENT_FONT_SIZE = ITEMS_CONTENT_FONT_SIZE;
