...
public class SheetAlternatedBackgroundEvent extends PdfPageEventHelper {
    ...
    private Image mainTitleRight;
    private Image mainTitleLeft;
    ...
    public void onOpenDocument(PdfWriter writer, Document document) {
        ...
        try {
            ...
            mainTitleRight.setAbsolutePosition(IMAGE_HEIGHT + IMAGE_BORDER * 2f + TITLE_BORDER,
