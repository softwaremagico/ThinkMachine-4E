...
public final class ModuleManager {
    ...
    private static final String[] TOTAL_MODULES = {FADING_SUNS_PLAYER_GUIDE_MODULE, FACTION_BOOK_MODULE, LOST_WORLDS_BOOK_MODULE,
            IMPERIAL_DOSSIER_BROTHER_BATTLE_MODULE, IMPERIAL_DOSSIER_CHARIOTEERS_GUILD_MODULE, IMPERIAL_DOSSIER_HOUSE_HAWKWOOD_MODULE, IMPERIAL_DOSSIER_REEVES_GUILD_MODULE};
