...
public class CyberneticDeviceTrait extends Element<CyberneticDeviceTrait> {
    ...
    private float extraCostMultiplier;
    private int extraIncompatibility;

    public CyberneticDeviceTrait() {
        super();
    }

    public CyberneticDeviceTrait(String id, TranslatedText name, TranslatedText description, String language, String moduleName,
