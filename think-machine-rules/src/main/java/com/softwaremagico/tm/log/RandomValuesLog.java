...
public final class RandomValuesLog extends BasicLogger {

    private static final Logger LOGGER = LoggerFactory.getLogger(RandomValuesLog.class);

    private RandomValuesLog() {
